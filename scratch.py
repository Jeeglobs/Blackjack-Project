...
class Card:
    # parameters in parenthises must be wrritten out when Card is called (see line 23)
    # if def __init__(self):
    # then self.suit = None (or some other base value), same for self.rank
...
new_game = Game()
# calls the Game class's init method in line 29
